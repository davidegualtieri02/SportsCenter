...
class FCampo_Pallavolo extends FCampo{
    ...
    private static $tabella = "Campo_Pallavolo"; 
    private static $valore = "(NULL,:id_campo, :copertura, :pavimento)";
    private static $chiave = "IDCampoPallavolo";
    ...
    public static function creaOggCampo_Pallavolo($risultatoQuery){
        ...
        if(count($risultatoQuery) == 1){
            ...
            $campo_pallavolo = new ECampo_Pallavolo($risultatoQuery[0]['id_campo'], $risultatoQuery[0]['copertura'], $risultatoQuery[0]['pavimento']);
            ...
            for($i = 0; $i < count($risultatoQuery); $i++){
                ...
                $campo_pallavolo = new ECampo_Pallavolo($risultatoQuery[$i]['id_campo'], $risultatoQuery[$i]['copertura'], $risultatoQuery[$i]['pavimento']);
    ...
    public static function bind($dichiarazione,$campo_pallavolo){
        $dichiarazione->bindValue(":id_campo", $campo_pallavolo->getId_campo(),PDO::PARAM_INT);
