...
class FCampo_Tennis extends FCampo{
    ...
    private static $tabella = "Campo_Tennis"; 
    private static $valore = "(NULL,:id_campo, :copertura, :terreno)";
    private static $chiave = "IDCampoTennis";
    ...
    public static function creaOggCampo_Tennis($risultatoQuery){
        ...
        if(count($risultatoQuery) == 1){
            ...
            $campo_tennis = new ECampo_Tennis($risultatoQuery[0]['id_campo'], $risultatoQuery[0]['copertura'], $risultatoQuery[0]['terreno']);
            ...
            for($i = 0; $i < count($risultatoQuery); $i++){
                //Crea un nuovo oggetto campo da tennis
                $campo_tennis = new ECampo_Tennis($risultatoQuery[$i]['id_campo'], $risultatoQuery[$i]['copertura'], $risultatoQuery[$i]['terreno']);
    ...
    public static function bind($dichiarazione,$campo_tennis){
        $dichiarazione->bindValue(":id_campo", $campo_tennis->getId_campo(),PDO::PARAM_INT);
