...
class EImage{
    ...
    public function __construct($nome, $grandezza, $tipi, $imageData){
    ...
    public function getId(){
        ...
        return self::$idImage; //Restituisce il valore dell'ID dell'immagine
    }

    //Definizione di un metodo per impostare l'ID dell'immagine
    public function setId($id){

        $this->idImage = $id; //Assegna il valore del parametro al campo idImage
    }
    ...
    public function getEncodedData(){
        ...
        return base64_encode($this->imageData); //Restituisce i dati dell'immagine codificati in base64
    }

    //Definizione di un metodo per ottenere la recensione a cui l'immagine appartiene
    public function getRecensione(){

        return self::$recensione; //Restituisce il valore della recensione a cui l'immagine appartiene
    }
    ...
    public function setRecensione(ERecensione $recensione): void{
        ...
        $this->recensione = $recensione; //Assegna il valore del parametro al campo recensione
    }
