...
class FAttrezzatura_Calcio extends FAttrezzatura{
    ...
    public static function creaOggAttrezzatura_Calcio($risultatoQuery){
        ...
        if(count($risultatoQuery) == 1){
            ...
            $attrezzatura_calcio->setId_attrezzatura($risultatoQuery[0]['id_attrezzaturaCalcio']);
            ...
            for($i = 0; $i < count($risultatoQuery); $i++){
                ...
                $attrezzatura_calcio->setId_attrezzatura($risultatoQuery[$i]['id_attrezzaturaCalcio']);
    ...
    public static function bind($dichiarazione,$attrezzatura_calcio){
        $dichiarazione ->bindValue(":id_attrezzaturaCalcio",$attrezzatura_calcio->getId_attrezzatura(),PDO::PARAM_INT);
