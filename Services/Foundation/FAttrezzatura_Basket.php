...
class FAttrezzatura_Basket extends FAttrezzatura{
    ...
    public static function creaOggAttrezzatura_Basket($risultatoQuery){
        ...
        if(count($risultatoQuery) == 1){
            ...
            $attrezzatura_basket->setId_attrezzatura($risultatoQuery[0]['id_attrezzaturaBasket']);
            ...
            for($i = 0; $i < count($risultatoQuery); $i++){
                ...
                $attrezzatura_basket->setId_attrezzatura($risultatoQuery[$i]['id_attrezzaturaBasket']);
    ...
    public static function bind($dichiarazione,$attrezzatura_basket){
        $dichiarazione->bindvalue(":id_attrezzaturaBasket",$attrezzatura_basket->getId_attrezzatura(),PDO::PARAM_INT);
