...
class FPersistentManager{
    ...
    public static function recuperaOggetto($classe,$id){ // $classe contiene il nome della classe passata come parametro alla funzione 
        ...
        // call_user_func permette di chiamare una funzione o metodo spercificato . in questo caso chiama il metodo contenuto in $metodoStatico
        ...
        // l'id specificato ci serve per prebdere quell'oggetto dal db tramite il suo ID .
