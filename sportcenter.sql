...
CREATE TABLE Utente(
    'id_utente' INT PRIMARY KEY, --Gli ID delle superclassi servono sia alla superclasse che alle sottoclassi perché, avendo le sottoclassi molti attributi unici, utilizziamo l'ereditarietà "TABELLA DI UNIONE", ovvero sia superclassi che sottoclassi hanno una tabella nel DB.
    'nome' VARCHAR(50),
    'cognome' VARCHAR(50),
    'password' VARCHAR(50),
    'email' VARCHAR (50);
...
CREATE TABLE CampoBasket(
    'id_campoBasket' INT PRIMARY KEY,
    'id_campo' INT,
    'copertura' VARCHAR (50),
...
CREATE TABLE CampoCalcio(
    'id_campoCalcio' INT PRIMARY KEY,
    'id_campo' INT,
    'copertura' VARCHAR (50),
    FOREIGN KEY (id_campo) REFERENCES Campo(id_campo)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE =utf8_unicode_ci;
CREATE TABLE CampoPadel(
    'id_campoPadel' INT PRIMARY KEY,
    'id_campo' INT,
    'copertura' VARCHAR(50),
    FOREIGN KEY (id_campo) REFERENCES Campo(id_campo)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE =utf8_unicode_ci;
CREATE TABLE CampoPallavolo(
    'id_campoPallavolo' INT PRIMARY KEY,
    'id_campo' INT,
    'copertura' VARCHAR(50),
    'pavimento' VARCHAR(50),
    FOREIGN KEY (id_campo) REFERENCES Campo(id_campo)
...
CREATE TABLE CampoTennis(
    'id_campoTennis' INT PRIMARY KEY,
    'id_campo' INT,
    'copertura' VARCHAR(50),
    'terreno' VARCHAR(50),
    FOREIGN KEY (id_campo) REFERENCES Campo(id_campo)
