...
/* Smarty version 4.3.2, created on 2024-07-12 23:32:19
  from '/Users/diegoromanelli/Desktop/PPIW/Progetto/SportsCenter/smarty/libs/templates/annulla_prenotazione.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_6691a0e3435bb7_75497500',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '293390a5108b9000d67831d4a23c2e710abc7439' => 
    array (
      0 => '/Users/diegoromanelli/Desktop/PPIW/Progetto/SportsCenter/smarty/libs/templates/annulla_prenotazione.tpl',
      1 => 1720770429,
      2 => 'file',
    ),
  ),
...
function content_6691a0e3435bb7_75497500 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="it">
<head>
  <meta charset="UTF-8">
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <div class="d-flex flex-column flex-lg-row align-items-center">
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <a class="nav-link" href="/SportsCenter/home">Home</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="/SportsCenter/prenotazioni">Prenotazioni</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="/SportsCenter/servizi">Servizi</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link current-page" href="/SportsCenter/contattaci">Contattaci</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="/SportsCenter/profilo">Profilo</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="layout_padding2-top">
        <div class="row">
          <div class="col-md-12 text-center">
            <p style="font-size: 18px;">Prenotazione annullata con successo.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-2 offset-md-1">
          ...
          <ul>
            ...
            <li class="">
              <a class="" href="/SportsCenter/profilo">Profilo</a>
            </li>
            <li class="">
