<?php
/* Smarty version 4.3.2, created on 2024-07-14 21:52:16
  from '/Applications/XAMPP/xamppfiles/htdocs/SportsCenter/smarty/libs/templates/utentiAdmin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_66942c70274100_24327675',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0ef4b28af3b8e182242a9fd4a98db3c6ff26b769' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/SportsCenter/smarty/libs/templates/utentiAdmin.tpl',
      1 => 1720986734,
      2 => 'file',
    ),
  ),
...
function content_66942c70274100_24327675 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
  ...
  <section class="about_section layout_padding">
    <div class="container">
      <div class="heading_container">
        <h2>
          Lista degli utenti in SportsCenter
        </h2>
      </div>
      <div class="box">
        <div class="detail-box">
          <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['listaUtenti']->value, 'utente');
...
?>
              <p><strong>ID utente:</strong> <?php echo $_smarty_tpl->tpl_vars['utente']->value['id_utenteRegistrato'];?>
; <strong>Nome:</strong> <?php echo $_smarty_tpl->tpl_vars['utente']->value['nome'];?>
; <strong>Cognome:</strong> <?php echo $_smarty_tpl->tpl_vars['utente']->value['cognome'];?>
; <strong>Email:</strong> <?php echo $_smarty_tpl->tpl_vars['utente']->value['email'];?>
.<br> 
              <?php if ($_smarty_tpl->tpl_vars['utente']->value['ban'] == 1) {?>
                Utente bannato; 
              <?php } else { ?>
                Utente non bannato; 
              <?php }?>
              <?php if ($_smarty_tpl->tpl_vars['utente']->value['id_tessera'] == 0) {?>
                Utente non tesserato.
              <?php } else { ?>
                Utente con ID tessera: <?php echo $_smarty_tpl->tpl_vars['utente']->value['id_tessera'];?>
.
              <?php }?>
                <br>
              <?php if ($_smarty_tpl->tpl_vars['utente']->value['ban'] == 0) {?>
                <a class="btn btn-primary" href="/SportsCenter/Amministratore/banUtente/<?php echo $_smarty_tpl->tpl_vars['utente']->value['id_utenteRegistrato'];?>
" id="tesseramento-button">Banna l'utente</a>
              <?php } else { ?>
                <a class="btn btn-primary" href="/SportsCenter/Amministratore/banUtente/<?php echo $_smarty_tpl->tpl_vars['utente']->value['id_utenteRegistrato'];?>
" id="tesseramento-button">Sbanna l'utente</a>
              <?php }?>
            </p><br>
          <?php
}
