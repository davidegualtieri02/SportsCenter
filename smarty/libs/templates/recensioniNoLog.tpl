    ...
    <div class="container">
      ...
      <div class="box">
        <div class="detail-box">
          ...
          <p><strong>Data della recensione:</strong> {$recensione.giorno}</p><br>
          <img src="data:{$recensione.tipoImg};base64,{$recensione.encodedDataImg}" alt="{$nomeImg}" style="width: 60%; height: auto;">
        </div>
      </div>
      {/foreach}
