  ...
  <div class="hero_area">
        ...
        <div class="container">
            ...
            <div class="box">
                <div class="detail-box">
                    <p>
                        Codice prenotazione: {$id_prenotazione}<br>
                        Data: {$dataPrenotazione}<br>
                        Orario: {$orarioPrenotazione}:00<br>
                        Campo: {$titoloCampo}<br>
                        Attrezzatura: 
                        {if $attrezzatura == 1}
                        richiesta.
                        {else}
                    ...
                    <a class="btn btn-primary" href="/SportsCenter/PrenotaCampo/annullaPrenotazione/{$id_prenotazione}">Annulla prenotazione</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="recensione_section layout_padding">
        <div class="container">
            ...
            <div class="box">
                <div class="detail-box">
                    <form id="recensione-form" action="/SportsCenter/Recensione/scriviRecensione/{$id_prenotazione}" method="post" enctype="multipart/form-data">
                        ...
                        <div id="preview"></div>
                        <br>
                        <a href = "/SportsCenter/Recensione/scriviRecensione/{$id_prenotazione}"><button type="submit" class="btn btn-success">Invia Recensione</button></a>
                    </form>
                </div>
            </div>
        </div>
